...
describe('OutputPanel', () => {
  ...
  it('shows "Waiting for input..." when no lines', async () => {
    const { OutputPanel } = await import('../../interactive/App.ts');
...
describe('StatusBar', () => {
  ...
  it('shows "No session" and "Ready" when idle', async () => {
    const { StatusBar } = await import('../../interactive/App.ts');
...
describe('InputPrompt', () => {
  ...
  it('shows placeholder when empty', async () => {
    const { InputPrompt } = await import('../../interactive/App.ts');
...
describe('InteractiveApp', () => {
  ...
  it('renders welcome message', async () => {
    const { InteractiveApp } = await import('../../interactive/App.ts');
...
describe('SessionManager', () => {
  ...
  it('creates session, imports template, starts, and invokes', async () => {
    const { SessionManager } = await import('../../interactive/App.ts');
