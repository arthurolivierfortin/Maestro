...
**Statut** : Planifie
**Prerequis** : Phase 54 COMPLETE (choix par contract au setup, Catalog organise)
...
| Phase | Titre | Effort |
|-------|-------|--------|
| 55-A | Auth + comptes utilisateurs | 3-5 jours |
| 55-B | Catalogue backend (publish/search/import par contract) | 3-5 jours |
| 55-C | TUI integration (local + community, par contract) | 2-3 jours |

---

## 55-A : Auth + comptes utilisateurs
