# Phase 38+ : Futur (Marketplace, Auth, Cloud)

**Statut** : Planification long-terme
**Prerequis** : Phase 37 COMPLETE (premiere version distribuee, feedback beta)
...
### Phase 38 : Catalogue communautaire
...
### Phase 39 : Auth et subscriptions
