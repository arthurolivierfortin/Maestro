...
| 59-D | TUI : visibilite complete de l'isolation (/status, CLI --tree, API parentSessionId) | 1 jour |
| 59-E | SpacesScreen refonte : enfants dans detail view, liste plate, badge [+N] | 0.5 jour |
