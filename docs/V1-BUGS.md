...
| # | Bug | Description | Cause | Phase cible |
|---|-----|-------------|-------|-------------|
| 3 | **Conflit providers silencieux** | Quand plusieurs providers supportent le meme modele (ex: ClaudeCode + Anthropic pour `claude-sonnet-4-6`), le systeme utilise le premier trouve sans prevenir l'utilisateur. Cause aussi des doublons dans ModelsScreen. | Pas de detection de conflit ni de mecanisme de priorite configurable par l'utilisateur. ProviderType collision corrigee en Phase 61 (ClaudeCode=8, Anthropic=4), mais le routage prioritaire manque. | 62 |
